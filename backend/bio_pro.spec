...
# SPECPATH is set by PyInstaller to the directory containing this spec file (backend/).
...
all_datas = (
    ...
    [
        ...
        (str(backend_dir / "data" / "seed_parts.py"), "data"),
        (str(backend_dir / "data" / "__init__.py"),   "data"),
    ]
...
all_hidden = (
    uvicorn_hidden + sqlalchemy_hidden
