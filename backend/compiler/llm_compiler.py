...
from models.schemas import IntentSpec, Trigger
from compiler import assembler, parser as rule_parser, validate
from compiler.llm_providers import get_provider
from compiler.parser import ParseError
from compiler.rules import supported_inducers, PATTERN_KEYWORDS
from simulation import ode

if TYPE_CHECKING:
    from models.schemas import CompileRequest, CompileResponse, LLMConfig, SimParams
...
async def compile_with_llm(
    ...
    import citations as cit_module
