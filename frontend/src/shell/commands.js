...
import { exportInline } from "../api/client.js";
...
async function saveActiveTab() {
  ...
  try {
    ...
    try {
      import("../lib/vscode-shim/workspace.js").then(({ _onDidSaveTextDocumentEmitter }) => {
        import("../lib/vscode-shim/text-document.js").then(({ monacoModelToTextDocument }) => {
