...
const AA_COLORS = {
  // Hydrophobic
  A: { bg: "#c8c8c8", fg: "#222" }, V: { bg: "#c8c8c8", fg: "#222" },
  I: { bg: "#c8c8c8", fg: "#222" }, L: { bg: "#c8c8c8", fg: "#222" },
  M: { bg: "#c8c8c8", fg: "#222" }, F: { bg: "#c8c8c8", fg: "#222" },
  W: { bg: "#c8c8c8", fg: "#222" }, P: { bg: "#c8c8c8", fg: "#222" },
  // Polar uncharged
  S: { bg: "#4ec94e", fg: "#fff" }, T: { bg: "#4ec94e", fg: "#fff" },
  C: { bg: "#e6c619", fg: "#222" }, Y: { bg: "#4ec94e", fg: "#fff" },
  N: { bg: "#4ec94e", fg: "#fff" }, Q: { bg: "#4ec94e", fg: "#fff" },
  // Charged positive
  K: { bg: "#3a7ebf", fg: "#fff" }, R: { bg: "#3a7ebf", fg: "#fff" },
  H: { bg: "#7b9ec9", fg: "#fff" },
  // Charged negative
  D: { bg: "#d9534f", fg: "#fff" }, E: { bg: "#d9534f", fg: "#fff" },
  // Special
  G: { bg: "#f5e04b", fg: "#222" },
  "-": { bg: "transparent", fg: "var(--fg-muted)" },
};
...
function residueColor(char, isNt) {
  ...
  return palette[char] ?? { bg: "#888", fg: "#fff" };
}
