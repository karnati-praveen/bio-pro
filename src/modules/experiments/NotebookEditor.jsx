    ...
    <div className="notebook-editor">
      ...
      <div className="notebook-list">
        <div className="notebook-list-head">
          ...
          <button className="btn micro" onClick={handleNew}>+ New</button>
        </div>
        <ul>
          {list.map((e) => (
            <li
      ...
      <div className="notebook-form">
        ...
        <div className="nb-section-title">
          Results
          <button className="btn micro" onClick={addColumn}>+ col</button>
          <button className="btn micro" onClick={addRow}>+ row</button>
        </div>
